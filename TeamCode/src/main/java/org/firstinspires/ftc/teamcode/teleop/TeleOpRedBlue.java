...
@TeleOp(name = "TeleOpOneController", group = "TeleOp")
public class TeleOpRedBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            } else if(gamepad1.left_trigger > 0.1){// This is in case the spinner rotation fails due to tele reset post autonomous
                spinner.setPower(-redMultiplier);
            }else {
                spinner.setPower(0);
            }
