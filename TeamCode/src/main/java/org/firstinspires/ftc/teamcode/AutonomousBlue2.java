...
@Autonomous (name = "AutonomousBlue2" , group = "Blue")
@Disabled
public class AutonomousBlue2 extends LinearOpMode {
    ...
    long ARM_DELAY_CASE_A = 600;//Delay for the Arm and claw to get into position in Traj 1
    long ARM_DELAY_CASE_B = 1100;//Delay for the Arm and claw to get into position in Traj 1
    long ARM_DELAY_CASE_C = 1200;//Delay for the Arm and claw to get into position in Traj 1
