...
@Autonomous (name = "AutonomousRed1" , group = "Red")
public class AutonomousRed1 extends LinearOpMode {
    //Positions to drive to
    Pose2d initPose = RedPositions.initPose;
    Pose2d[] grabPose = RedPositions.grabPose;
    Pose2d preDrop = new Pose2d(-30, -41, 0.7);
    Pose2d dropPose = RedPositions.dropPose; // new Pose2d(-24, -33, 0.7);
    ...
    //Initializing robot trajectories
    ...
    void setupTrajFordeliverCargoAndDuck() {
        ...
        traj4 = drive.trajectorySequenceBuilder(spinnerPose)
                ...
                .splineToConstantHeading(new Vector2d(-45, -50), 0)
                .splineToSplineHeading(new Pose2d(-36, -61, 1.05), -PI/2)
                .lineTo(new Vector2d(-60,-61))
                .setVelConstraint(SampleMecanumDrive.getVelocityConstraint(10, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH))
                .lineToLinearHeading(new Pose2d(-62, -53, 0))
                .resetVelConstraint()
                .setTangent(0)
