...
@Autonomous (name = "AutonomousBlue3" , group = "Blue")
@Disabled
public class AutonomousBlue3 extends LinearOpMode {
    ...
    Pose2d dropPose2 = new Pose2d(1, 36, -2);
    Pose2d intakePose = new Pose2d(46, 62, PI);
    Pose2d intakePose2 = new Pose2d(52, 63, PI);
    Pose2d intakePose3 = new Pose2d(56, 64, PI);
    Pose2d parkPose = new Pose2d(46, 65, PI);

    long ARM_DELAY_CASE_A = 800;//Delay for the Arm and claw to get into position in Traj 1
    long ARM_DELAY_CASE_B = 1100;//Delay for the Arm and claw to get into position in Traj 1
    long ARM_DELAY_CASE_C = 1100;//Delay for the Arm and claw to get into position in Traj 1
    ...
    int WAREHOUSE_DIST_INCREMENT = 1;
